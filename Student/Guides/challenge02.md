...
2. Assign the `challenge 2` work item to yourself.
3. Using the kanban board, move your `challenge 2` work item to the resolved state. 
...
2. You should see 9 work item cards on your kanban board. 
